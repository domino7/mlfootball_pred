...
if __name__ == "__main__":
	with open('learning_data01.csv') as learning_vector, open('teamsAgeTMV.csv') as teams_age, open('new_vector.csv', 'w+') as output:
		fieldnames = ['Match_id','League_id','Season','Stage','Date','H_team','A_team','Result','B365H','B365D','B365A','H_Speed','H_Pass','H_Shoot','H_Pressure','H_chPass','H_chCross','H_dAggr','H_dWidth','A_Speed','A_Pass','A_Shoot','A_Pressure','A_chPass','A_chCross','A_dAggr','A_dWidth', 'H_age', 'A_age']
