...
if __name__ == "__main__":
	with open('Team_Attributes') as team_attributes_file, open('Match.csv') as match_file, open('learning_vectors2.csv', 'w+') as output:
		fieldnames = ['Match_id', 'League_id', 'Season', 'Stage', 'Date', 'home_team_api_id', 'away_team_api_id', 'Result', 'B365H', 'B365D' ,'B365A' ,'HomeTeam_buildUpPlaySpeed' ,'HomeTeam_buildUpPlayPassing', 'HomeTeam_chanceCreationShooting', 'HomeTeam_defencePressure', 'AwayTeam_buildUpPlaySpeed', 'AwayTeam_buildUpPlayPassing', 'AwayTeam_chanceCreationShooting', 'AwayTeam_defencePressure']
