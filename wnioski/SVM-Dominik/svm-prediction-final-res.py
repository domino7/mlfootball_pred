...
def svm_final_result(current_predictors):
    results = []
    for i in range(50):
    ...
    print(results)
    print("(mean, std): (%0.3f, %0.3f)" % (results.mean(), results.std()))





# svm_final_result(predictors2)


"""
Adding DIFF components
"""
...
svm_final_result(predictors3_diff)